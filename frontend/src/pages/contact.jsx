			...
			<section className="mx-auto max-w-screen-xl px-4 py-20 sm:px-6 lg:px-8">
				<div className="grid grid-cols-1 gap-x-16 gap-y-8 lg:grid-cols-5">
					...
					<div className="lg:col-span-2 lg:py-12">
						<h1 className="text-2xl font-extrabold text-white sm:text-4xl">Contact Us.</h1>
						<p className="max-w-xl text-xs mt-2 sm:text-sm text-white">
							...
							virtual doors are always open. Drop us a line, and let's make things happen together.
						</p>
